...
/**
 * desc: {@link android.content.SharedPreferences} 帮助类 <br/>
...
public class SharedPreferenceHelper {
    ...
    public SharedPreferenceHelper(@NonNull Context context, @NonNull String fileName, int mode) {
     ...
     * @param key   key
     * @param value 保存的值
     * @return 当前SharedPreferenceHelper对象
     */
    @NonNull
    public SharedPreferenceHelper setString(@NonNull final String key, @NonNull final String value) {
     ...
     * @return 当前SharedPreferenceHelper对象
     */
    public SharedPreferenceHelper setBoolean(@NonNull final String key, final boolean value) {
     ...
     * @return 当前SharedPreferenceHelper对象
     */
    public SharedPreferenceHelper setInt(@NonNull final String key, final int value) {
     ...
     * @return 当前SharedPreferenceHelper对象
     */
    public SharedPreferenceHelper setFloat(@NonNull final String key, final float value) {
     ...
     * @return 当前SharedPreferenceHelper对象
     */
    public SharedPreferenceHelper setLong(@NonNull final String key, final long value) {
     ...
     * @return 当前SharedPreferenceHelper对象
     */
    public SharedPreferenceHelper setStringSet(@NonNull final String key, final Set<String> value) {
